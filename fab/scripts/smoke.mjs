...
const EXPECTATIONS = {
  ...
  '/app/dashboard': ['Executive dashboard', 'Order book', 'Revenue vs target', 'Delayed orders'],
  '/app/hr/employees': ['Arjun Mehta', 'Headcount', 'Merchandising'],
  '/app/hr/departments': ['Merchandising', 'Share of headcount'],
  '/app/hr/attendance': ['Attendance rate', 'Mon'],
  '/app/hr/leave': ['Awaiting approval', 'Approved days'],
  '/app/hr/payroll': ['Net paid', 'Deductions'],
  '/app/reports': ['Available reports', 'Order book', 'Vendor performance'],
